...
public class ChatPanelView extends AbstractView {
    ...
    public static final String LOGOUT_ACTION_COMMAND = "log out";
    ...
    private static String messagesTextPaneColor = "#FF9900";
    private static String usersTextPaneColor = "#FF6666";
    ...
    public void initModel(boolean getMessages){
        ...
        getPromptLabel().setText("You are logged in as " + parent.getModel().getLoggedUser() + ".");
    ...
    public JList getUsersList() {
        if (usersList == null){
            ...
            usersList.setFont(new Font("Harrington", Font.BOLD, 16));
            usersList.setBackground(Color.decode(usersTextPaneColor));
            usersList.setForeground(Color.decode("#000000"));
    ...
    private JLabel getPromptLabel(){
        if (promptLabel == null){
            promptLabel = new JLabel("You are logged in as " + parent.getModel().getLoggedUser() + ".");
        }
        return promptLabel;
    }
